...
For each of the following scenarios in Exercises 3 - 6,
...
What went wrong in #17? Explain as best you can.
...
Determine the sample size necessary to obtain a maximum margin of error of 0.1 when estimating the average movie rating using a 90%, 95%, and 99% confidence interval. Assume you found in a small pilot study that the standard deviation of the ratings was `r round(sd, 2)`.
